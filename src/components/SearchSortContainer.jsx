        ...
        <div className="flex items-center space-x-4 flex-grow">
          ...
          <div className="relative w-64">
            <input
              ...
              className="pl-10 pr-4 py-1 w-full rounded-full bg-gray-100 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-unleash-blue focus:border-unleash-blue"
              value={search}
              onChange={(e) => {
            ...
            />
            <div className="absolute left-3 top-1 text-black">
          ...
          <div className="flex items-center bg-gray-100 rounded-full border border-gray-300 px-3 py-1">
